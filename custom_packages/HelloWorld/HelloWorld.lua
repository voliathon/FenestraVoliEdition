...
fw.ui.display(function()
    local success, err = pcall(function()
        if state.show_ui then
            ...
            -- THE FIX: If the C++ engine says the X was clicked, we honor it.
...
fw.command.register('hw', function(args)
    ...
    local success, err = pcall(function()
        ...
        elseif cmd == 'binary' then
            ...
            local my_data = { weapon = "Excalibur", damage = 9999 }
        ...
        elseif cmd == 'scan' then
            ...
            fw.chat.print("FenestraSDK Showcase Commands:", fw.ui.color.system_white)
...
addon.unload = function()
    ...
    fw.chat.print("FenestraSDK Showcase has been unloaded cleanly.", fw.ui.color.system_white)
end

fw.chat.print("FenestraSDK Showcase Loaded! Type /hw", 207)
